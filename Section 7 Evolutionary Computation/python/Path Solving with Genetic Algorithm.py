...
# Test the logger
log_to_json(logging.INFO, "This is a test log message", example_key="example_value")
...
def visualize_path(path):
    try:
        if path is None:
            logging.error("No path to visualize.")
            return
        ...
        logging.error(f"Error in visualize_path: {e}")
