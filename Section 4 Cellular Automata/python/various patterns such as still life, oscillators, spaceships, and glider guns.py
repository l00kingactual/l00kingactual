...
simkin_glider_gun = np.zeros((35, 9), dtype=int)
simkin_glider_gun_coords = [
    (1, 1), (2, 1), (3, 1),
    (1, 2), (2, 2), (3, 2),
    (2, 3),
    (4, 5), (5, 5), (6, 5), (7, 5),
...
for (x, y) in simkin_glider_gun_coords:
    simkin_glider_gun[x, y] = 1

patterns["simkin_glider_gun"] = simkin_glider_gun
...
add_pattern(grid, "HWSS", 50, 50)
add_pattern(grid, "gosper_glider_gun", 0, 0)  # Place it near the top-left corner to fit within bounds
add_pattern(grid, "simkin_glider_gun", 10, 50)  # Adjusted position to fit within bounds
