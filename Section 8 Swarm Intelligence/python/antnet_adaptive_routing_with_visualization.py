...
class AntNet:
    def __init__(self, num_nodes, alpha=1, beta=2, rho=0.1, Q=1, num_ants=10):
        ...
        self.pheromones = np.ones((num_nodes, num_nodes)) / num_nodes  # Initialize pheromones
        self.heuristic = np.ones((num_nodes, num_nodes))  # Initialize heuristic values
    ...
    def run(self, num_iterations, delay_matrix):
        ...
        try:
            ...
            print(f"An error occurred during the AntNet run: {e}")
    ...
    def forward_ant(self, source, destination, delay_matrix):
        ...
        try:
            ...
            print(f"An error occurred during the forward ant phase: {e}")
    ...
    def choose_next_node(self, current_node, destination):
        ...
        try:
            ...
            print(f"An error occurred during node selection: {e}")
            next_node = np.random.randint(0, self.num_nodes)  # Fallback to random selection
    ...
    def backward_ant(self, path, path_delay):
        ...
        try:
            ...
            print(f"An error occurred during the backward ant phase: {e}")
...
def normalize_pheromones(pheromones):
    ...
    try:
        ...
        print(f"An error occurred during pheromone normalization: {e}")
        return pheromones
...
def run_pygame_simulation(pheromones, coordinates, screen_width=800, screen_height=600):
    """
    Run a Pygame simulation to visualize the pheromone levels in 2D.
    ...
    try:
        ...
        print(f"An error occurred during the Pygame simulation: {e}")
    finally:
        pygame.quit()
        sys.exit()
