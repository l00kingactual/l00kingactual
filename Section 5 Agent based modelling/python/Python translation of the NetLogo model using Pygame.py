...
NUM_BOIDS = 100  # Number of boids in the simulation
...
class Boid:
    ...
    def update(self, boids):
        alignment = np.zeros(2)  # Initialize the alignment force vector
        cohesion = np.zeros(2)  # Initialize the cohesion force vector
        separation = np.zeros(2)  # Initialize the separation force vector
